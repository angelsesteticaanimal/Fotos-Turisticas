...
$('fitBtn').onclick=fitPhoto;$('autoFitBtn').onclick=()=>autoFitPerson();$('restoreBtn').onclick=restorePhoto;$('rotateBtn').onclick=()=>{rotation=(rotation+90)%360;draw()};$('resetBtn').onclick=()=>{photo=null;processed=null;processedBase=null;alphaBounds=null;scale=1;offsetX=offsetY=rotation=0;zoomEl.value=1;brightnessEl.value=contrastEl.value=100;invalidate();refineEnabled=false;setModeUI();draw();};
...
buildFrames();setModeUI();loadFrame(0);draw();
